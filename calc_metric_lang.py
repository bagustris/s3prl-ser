...
def main():
    parser = argparse.ArgumentParser(
        ...
        "Example: python calc_metric_lang.py result/downstream/emofilm-wavlm/ --label-csv s3prl/downstream/emofilm/EmoFilm_labels_16k_train_dev_split.csv\n"
        "Author: b-atmaja@aist.go.jp",
    ...
    parser.add_argument(
        "--label-csv",
        type=str,
        default="s3prl/downstream/emofilm/EmoFilm_labels_16k_train_dev_split.csv",
